...
const Footer1: FunctionComponent<Footer1Type> = ({ className = "" }) => {
  return (
    <footer
      className={`self-stretch overflow-hidden flex flex-col items-start justify-start pt-16 px-0 pb-0 box-border bg-[url('/public/footer@3x.png')] bg-cover bg-no-repeat bg-[top] max-w-full z-[1] text-left text-base text-white font-franie gap-[98px] mq800:pt-[42px] mq800:box-border ${className}`}
    >
          ...
          <div className="w-[400px] flex flex-col items-start justify-start gap-4 max-w-full">
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-4 max-w-full">
              <div className="relative w-80">
                <input
                  className="border-gray1-400 border-[1px] border-solid py-1 px-6 pr-10 bg-gray1-500 self-stretch rounded-lg box-border flex flex-row items-center justify-center gap-2 whitespace-nowrap max-w-full hover:bg-darkslategray-100 hover:border-dimgray-500 hover:border-[1px] hover:border-solid hover:box-border w-full h-10"
                  type="text"
                  placeholder="Enter your email"
                />
                <img
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 w-[18px] h-[18px] overflow-hidden"
                  alt=""
                  src="/email-mail.svg"
                />
              </div>
