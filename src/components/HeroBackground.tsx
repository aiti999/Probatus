    ...
    >
      <div className="w-[740px] flex flex-col items-start justify-start gap-4 max-w-full">
        <div className="self-stretch flex flex-row items-start justify-start relative max-w-full">
          <h1 className="m-0 h-[211px] flex-1 relative text-inherit leading-[72px] inline-block max-w-full font-[inherit] mq800:text-26xl mq800:leading-[58px] mq1150:text-15xl mq1150:leading-[43px]">
