  ...
  return (
    ...
    >
      <div className="self-stretch flex flex-col items-center justify-start gap-[64px] mq450:gap-[32px] ">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[30px] text-left text-[18px]">
          {serviceData.map((service) => (
            <div
              key={service.title}
              className="h-[296px] w-[296px] rounded-[12px] bg-[#fff] border-[rgba(33,33,33,0.2)] border-[1px] border-solid box-border overflow-hidden shrink-0 flex flex-col items-center justify-start py-[44px] px-[31px] min-w-[296px] lg:w-[calc(50%-1px)] xl:w-[calc(25%-15px)]"
            >
