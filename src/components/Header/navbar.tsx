...
const Navbar: FunctionComponent<NavbarProps> = ({
  ...
  return (
    <header
      className={`fixed top-0 left-1 right-12 py-5 px-12 z-50 bg-opacity-85 flex items-center justify-between ${className}`}
    >
      <div>
        <img
      ...
      <nav className="flex mq450:hidden flex-row items-center pr-12 justify-end gap-10 text-center font-semibold text-gray-300">
        ...
        <div>
          ...
          <button className="cursor-pointer border border-solid bg-color-rgba(23, 23, 23, 1) border-gray-900 py-1.5 px-3 ml-44 bg-gray-800 rounded-lg flex flex-row items-center justify-center gap-2">
            <a
              className="hover:border-neutral-600 no-underline relative text-sm leading-5 capitalize text-gray-200 inline-block"
              href="#book"
            >
              Book a Call
            </a>
      ...
      <button
        className="ss:hidden text-white absolute right-3 bg-transparent z-50"
      ...
      {/* Mobile Sidebar */}
      <div
        className={`md:hidden fixed top-0 right-0 h-1/2 w-[27rem] bg-[url('/public/component-1@3x.png')]  transform ${
        ...
        <div className="flex flex-col h-full p-4">
          ...
          <div className="mt-auto">
            <button className="cursor-pointer border mb-20 ml-16 border-solid left-16 border-gray-900 py-1.5 px-1 bg-gray-800 rounded-lg flex flex-row items-center justify-center gap-1.5 w-2/3">
              <a
                className="hover:border-neutral-600 relative text-sm leading-5 capitalize font-inter text-gray-200 inline-block"
                href="#book"
              >
                Book a Call
              </a>
