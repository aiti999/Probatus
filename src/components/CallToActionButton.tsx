...
const CallToActionButton: React.FC = () => (
  <div className="h-9 flex flex-col items-start justify-start pt-2 pb-0 pr-2 box-border">
    <button className="cursor-pointer border border-solid border-gray-900 py-1.5 px-3 bg-[rgba(31,30,30,1)] h-8 rounded-lg flex flex-row items-start justify-start">
