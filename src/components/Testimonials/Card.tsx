...
const Card: FunctionComponent<CardType> = ({
  ...
  return (
    <div
      className={`w-[32.125rem] h-[21.17rem]  bg-[#fff] border-[#f3efff] border-[0.0625rem] border-solid box-border shrink-0 flex flex-col items-start justify-start py-[2rem] px-[1.9375rem] max-w-full text-left text-[1rem] text-[#605f5f] font-[Inter] mq825:w-[calc(100%_-_2.5rem)] mq450:h-[25.4rem] mq450:w-[25rem] ${className}`}
    >
