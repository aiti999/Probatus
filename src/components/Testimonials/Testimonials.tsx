...
const Testimonial: FunctionComponent<TestimonialType> = ({ className = "" }) => {
  ...
  {testimonialData.heading}
      ...
      <div className="absolute bottom-24 w-[55%] h-[27.3125rem] rounded-[0.75rem] z-[0] bg-gradient-to-r from-green-300 to-yellow-200 mq450:w-[25rem] mq450:h-[30.125rem] mq450:top-[13rem] mq450:opacity-[0.32]"></div>
      <Splide
  options={{
    type: 'loop',
    perPage: 3,
  ...
  hasTrack={false}
  className="w-full mq450:w-full mq450:h-[28rem] px-4 mq450:top-[3rem] mq450:left-[.3rem]"
>
  <SplideTrack>
  ...
  <div className="splide__arrows flex justify-center mt-4 relative left-4 top-8 mq450:left-[5%] mq450:top-[10%]">
    <button className="splide__arrow splide__arrow--prev bg-white text-black px-[1.25rem] py-[1rem] rounded-md mx-2 top-[22%] left-[46%] mq450:left-[30%] mq450:top-[2%]">
      <img src="/frame-5.svg" alt="Previous" className="w-8 h-8 mq450:w-[2rem] mq450:h-[2rem]"/>
    </button>
    <button className="splide__arrow splide__arrow--next bg-white text-black px-[1.25rem] py-[1rem] rounded-md mx-2 top-[23%] right-[45%]">
