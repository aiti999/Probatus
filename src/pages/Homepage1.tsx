...
const Homepage1: FunctionComponent = () => {
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal]">
      <section className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-[253px] box-border gap-28 bg-[url('/public/hero@3x.png')] bg-cover bg-no-repeat bg-[top] [mix-blend-mode:linear-burn] max-w-full gap-14 mq800:pb-[164px] mq800:box-border gap-7 mq1150:pb-[107px] mq1150:box-border">
        <HeroContent />
        <HeroBackground />
      </section>
      <About />
      ...
      />
      <Process />
      <FrameComponent whyChooseUs="/why-choose-us@2x.png" />
      <section className="self-stretch flex flex-row items-start justify-center pt-0 px-5 pb-[74px] box-border max-w-full text-center text-lg text-gray-600 font-franie">
        <div className="w-[580px] flex flex-col items-start justify-start gap-2 max-w-full">
          ...
          <h1 className="m-0 self-stretch relative text-23xl leading-[48px] font-normal font-[inherit] text-gray-900 mq800:text-15xl mq800:leading-[38px] mq1150:text-6xl mq1150:leading-[29px]">
